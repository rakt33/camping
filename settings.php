			  ...
			  <div class="tab-pane" id="settings">
                <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputUsername" placeholder="<?php echo $_SESSION['username'] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="inputRank" class="col-sm-1 control-label">Rank</label>

                    <div class="col-sm-10">
						<select class="form-control">
						  <option value="volvo">deliverer</option>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="password">
				...
				<form class="form-horizontal">
					...
					<div class="form-group">
						<label for="inputPassword2" class="col-sm-3 control-label">Retyp password</label>
